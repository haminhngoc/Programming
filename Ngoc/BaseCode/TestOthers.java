...
public class TestOthers {
	...
	static String INPUT = "6 " + "5 " + "14 " + "2 1 -1 2 5 8 9 1 2 3 3 3 2 1 " + "4 " + "11 "
			+ "3 2 1 -1 -1 -1 3 4 5 5 5 " + "20 " + "11 " + "2 4 6 8 11 14 17 21 45 50 100 " + "1 " + "5 "
			+ "1 1 1 1 1 " + "-1 " + "5 " + "1 1 1 1 1 "
			+ "      5 62 1 2 5 3 1 5 1 5 1 5 1 5 1 1 5 1 2 3 4 6 7 8 9 10 9 8 7 6 5 6 7 10 11 12 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11 12";

	static final Modes mode = Modes.TEST;

	public static void main(String[] args) {
		// generateTestCase(2, 1, 1000000);// run in mode test;
		setMode(mode);
		input();
		long s;
	...
	static void solve(int s[], int k) {
		...
		for (int i = 0; i < length; i++) {
			...
			if (maxVal - minVal > k && posMaxVal < posMinVal) {
				...
				while (pivotLeft < pivotRight && s[pivotLeft] - s[pivotRight] > k) {
					pivotLeft++;
				}
				i = pivotLeft - 1;
				minVal = INF;
			...
			if (maxVal - minVal > k && posMaxVal > posMinVal) {
				...
				while (pivotLeft < pivotRight && s[pivotRight] - s[pivotLeft] > k) {
					pivotLeft++;
				}
				i = pivotLeft - 1;
				minVal = INF;
